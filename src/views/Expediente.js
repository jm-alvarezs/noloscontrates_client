...
class Expediente extends Component {
    ...
    renderExpediente() {
        ...
        return <ExpedienteCard expediente={this.props.expediente} id_expediente={this.getIdExpediente()} />
    }
...
export default connect(mapStateToProps, { getNoticias, getExpediente })(Expediente);